...
<template>
	<header class="mx-auto px-4 bg-blue-200 fixed w-full z-50 flex items-center justify-between">
		...
		<div
			:class="
				!mobileMenu ?
					'block md:hidden text-cyan-500 relative z-30 top-0' :
					'block md:hidden text-purple-500 relative z-30 top-0 flex justify-center w-full py-4'
			"
			@click="toggleMenu">
